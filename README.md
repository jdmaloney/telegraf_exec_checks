...
a) The name of the CNI used in the cluster (eg. flannel, weave, etc)
b) The path to a kubectl command that has permissions to view all namespaces on the cluster
